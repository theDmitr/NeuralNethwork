...
public class RuntimeExceptions {
    ...
    public static final RuntimeException inputOutput = new RuntimeException("[NeuralNetwork Error] The number of input/output values does not match the number of input/output neurons!");
